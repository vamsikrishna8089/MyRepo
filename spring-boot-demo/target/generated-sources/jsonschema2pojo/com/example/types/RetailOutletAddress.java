...
public class RetailOutletAddress {
     ...
     */
    @JsonProperty("outletNameOrNumber")
    public String getOutletNameOrNumber() {
        return outletNameOrNumber;
    }
     ...
     */
    @JsonProperty("outletNameOrNumber")
    public void setOutletNameOrNumber(String outletNameOrNumber) {
        this.outletNameOrNumber = outletNameOrNumber;
    }
    ...
    public String toString() {
        ...
        sb.append(RetailOutletAddress.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("outletNameOrNumber");
        sb.append('=');
        sb.append(((this.outletNameOrNumber == null)?"<null>":this.outletNameOrNumber));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.outletNameOrNumber == null)? 0 :this.outletNameOrNumber.hashCode()));
        return result;
    }
